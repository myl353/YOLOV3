...
module02是在网络中对输出加了激活函数，所以这里就不需要加了
...
class Detector(torch.nn.Module):
    ...
    def _parse(self, idxs, vecs, t, anchors):
        ...
        sigmiod的作用是将其控制在0-1之间
        由于是网络层中加的sigmiod，所以这里不需要加sigmoid
        '''
        # t是尺度相对原图的缩放比例
...
if __name__ == '__main__':
    ...
    detector = Detector(model_path=r'models/yolov3_two04_02_01.pth')
    img_path='data1/images/11.jpg'
